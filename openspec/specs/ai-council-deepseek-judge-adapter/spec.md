# ai-council-deepseek-judge-adapter Specification

## Purpose

Defines the DeepSeek content-script adapter behavior used to submit a judge prompt to DeepSeek and confirm the send without capturing the judge response.
