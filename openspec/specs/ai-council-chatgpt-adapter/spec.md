# ai-council-chatgpt-adapter Specification

## Purpose

Defines the ChatGPT content-script adapter behavior that automates prompt submission and response extraction against the ChatGPT web UI using configurable selectors.
