# ai-council-multi-agent-orchestration Specification

## Purpose

Defines the multi-agent orchestration behavior that runs selected agent apps in parallel and hands off to a configurable judge app.
## Requirements
